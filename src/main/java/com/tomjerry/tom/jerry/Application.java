...
//				cinemaRepo.save(new Season("first", 1, Arrays.asList(
//						new Series("01. За что наказали кота", 1, 1),
//						new Series("02. Поздний ужин", 2, 1),
//						new Series("03. Ночь перед Рождеством", 3, 1),
//						new Series("04. Кот-трусишка", 4, 1),
//						new Series("05. Пес - нам не товарищ", 5, 1),
//						new Series("06. Гости не должны скучать", 6, 1),
//						new Series("07. Мышонок-стратег", 7, 1),
//						new Series("08. К чему приводит жадность", 8, 1),
//						new Series("09. Давай сыграем в кегли", 9, 1),
//						new Series("10. Пернатая заступница", 10, 1),
//						new Series("11. Когда мышонку стало скучно", 11, 1),
//						new Series("12. Нелегко быть младенцем", 12, 1),
//						new Series("13. Кот-стиляга", 13, 1),
//						new Series("14. Телохранитель", 14, 1),
//						new Series("15. В собачьей шкуре", 15, 1),
//						new Series("16. Неуловимый мышонок", 16, 1),
//						new Series("17. Романтический ужин", 17, 1),
//						new Series("18. Мышонок в Нью-Йорке", 18, 1),
//						new Series("19. Игра в гольф", 19, 1))));
//				cinemaRepo.save(new Season("second",2, Arrays.asList(
//						new Series("Слава Україні", 1, 2),
//						new Series("Слава Нації", 2, 2),
//						new Series("Смерть ворогам", 3, 2))));
//				cinemaRepo.save(new Season("third",3, Arrays.asList(
//						new Series("3 season", 1, 3),
//						new Series("3 sea", 2, 3),
//						new Series("3", 3, 3),
//						new Series("season", 4, 3))));
//				cinemaRepo.save(new Season("four",4, Arrays.asList(
